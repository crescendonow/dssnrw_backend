...
$sql.= ", row_to_json((SELECT l FROM (SELECT lg.dma_no || ' ' || lg.dma_name AS dma_name) As l ";
$sql.= ")) As properties ";
$sql.= "FROM ".$table_pipe." As lg WHERE pwa_code='".$pwa_code."'"." AND dma_no = '{$dma_no}' ";
$sql.= ") As f )  As fc ";
