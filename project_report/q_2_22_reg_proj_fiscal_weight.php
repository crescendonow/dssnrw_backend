...
if ($act == "group_project_weight") {
    ...
    $q_project_weight_improve = " SET CLIENT_ENCODING TO 'utf-8'; 
        ...
        (SELECT pm.zone, pm.pwa_code, project_prov_name, pipe_id, pipe_type, pipe_size, pipe_long, proj_cost, project_prov_id, 
                            ...
                            WHERE pm.zone = '{$reg}' AND fiscal_year = '{$proj_fiscal}' AND budget_type = '{$proj_budget}' 
                            ...
                            pipe_long, pipe_age, r_score, dma_nrw, proj_cost, remark, uid_insert, ls.leak_value1, ls.leak_value2, 
                            cs.cost_value1, cs.cost_value2
                            ORDER BY pm.zone, pm.pwa_code, project_prov_name, project_prov_id, pipe_id, pipe_type, pipe_size ) imp 
...
if ($act == "group_pipeid_weight") {
    ...
    $q_pipe_id_weight_improve = " SET CLIENT_ENCODING TO 'utf-8'; 
		        ...
		        GROUP BY pm.zone, pm.pwa_code, project_prov_name, project_prov_id, pipe_id, pipe_type, 
                    ...
                    ORDER BY pm.zone, pm.pwa_code, project_prov_name, project_prov_id, pipe_id, pipe_type, pipe_size   ";
