...
if ($act == 'group_pipetype') {
    ...
    $q_pipe_type = "    SET CLIENT_ENCODING TO 'utf-8'; 
                        ...
                        WHERE pm.zone = '{$reg}' AND rm.budget_type = '{$proj_budget}' AND rm.fiscal_year = '{$proj_fiscal}' AND rm.approve_status = 1 
                        ...
                        ORDER BY pm.pwa_code, pm.project_prov_id, pipe_type, pipe_size ";
